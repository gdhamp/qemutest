\hypertarget{group__FIR}{}\section{Finite Impulse Response (F\+IR) Filters}
\label{group__FIR}\index{Finite Impulse Response (\+F\+I\+R) Filters@{Finite Impulse Response (\+F\+I\+R) Filters}}
...
The F\+IR filter algorithm is based upon a sequence of multiply-\/accumulate (M\+AC) operations. Each filter coefficient {\ttfamily b\mbox{[}n\mbox{]}} is multiplied by a state variable which equals a previous input sample {\ttfamily x\mbox{[}n\mbox{]}}. 
\begin{DoxyPre}
...
\index{Finite Impulse Response (\+F\+I\+R) Filters@{Finite Impulse Response (\+F\+I\+R) Filters}!arm\+\_\+fir\+\_\+f32@{arm\+\_\+fir\+\_\+f32}}
\index{arm\+\_\+fir\+\_\+f32@{arm\+\_\+fir\+\_\+f32}!Finite Impulse Response (\+F\+I\+R) Filters@{Finite Impulse Response (\+F\+I\+R) Filters}}
...
\item[{const arm\+\_\+fir\+\_\+instance\+\_\+f32 $\ast$}]{S, }
\item[{float32\+\_\+t $\ast$}]{p\+Src, }
\item[{float32\+\_\+t $\ast$}]{p\+Dst, }
\item[{uint32\+\_\+t}]{block\+Size}
\end{DoxyParamCaption}
)}\hypertarget{group__FIR_gae8fb334ea67eb6ecbd31824ddc14cd6a}{}\label{group__FIR_gae8fb334ea67eb6ecbd31824ddc14cd6a}

\begin{DoxyParams}[1]{Parameters}
\mbox{\tt in}  & {\em $\ast$S} & points to an instance of the floating-\/point F\+IR filter structure. \\
\hline
...
none. 
\end{DoxyReturn}
\index{Finite Impulse Response (\+F\+I\+R) Filters@{Finite Impulse Response (\+F\+I\+R) Filters}!arm\+\_\+fir\+\_\+fast\+\_\+q15@{arm\+\_\+fir\+\_\+fast\+\_\+q15}}
\index{arm\+\_\+fir\+\_\+fast\+\_\+q15@{arm\+\_\+fir\+\_\+fast\+\_\+q15}!Finite Impulse Response (\+F\+I\+R) Filters@{Finite Impulse Response (\+F\+I\+R) Filters}}
...
\begin{DoxyParamCaption}
\item[{const arm\+\_\+fir\+\_\+instance\+\_\+q15 $\ast$}]{S, }
\item[{q15\+\_\+t $\ast$}]{p\+Src, }
\item[{q15\+\_\+t $\ast$}]{p\+Dst, }
\item[{uint32\+\_\+t}]{block\+Size}
\end{DoxyParamCaption}
)}\hypertarget{group__FIR_gac7d35e9472e49ccd88800f37f3476bd3}{}\label{group__FIR_gac7d35e9472e49ccd88800f37f3476bd3}
...
\end{DoxyParagraph}
\index{Finite Impulse Response (\+F\+I\+R) Filters@{Finite Impulse Response (\+F\+I\+R) Filters}!arm\+\_\+fir\+\_\+fast\+\_\+q31@{arm\+\_\+fir\+\_\+fast\+\_\+q31}}
\index{arm\+\_\+fir\+\_\+fast\+\_\+q31@{arm\+\_\+fir\+\_\+fast\+\_\+q31}!Finite Impulse Response (\+F\+I\+R) Filters@{Finite Impulse Response (\+F\+I\+R) Filters}}
\subsubsection[{\texorpdfstring{arm\+\_\+fir\+\_\+fast\+\_\+q31(const arm\+\_\+fir\+\_\+instance\+\_\+q31 $\ast$\+S, q31\+\_\+t $\ast$p\+Src, q31\+\_\+t $\ast$p\+Dst, uint32\+\_\+t block\+Size)}{arm_fir_fast_q31(const arm_fir_instance_q31 *S, q31_t *pSrc, q31_t *pDst, uint32_t blockSize)}}]{\setlength{\rightskip}{0pt plus 5cm}I\+A\+R\+\_\+\+O\+N\+L\+Y\+\_\+\+L\+O\+W\+\_\+\+O\+P\+T\+I\+M\+I\+Z\+A\+T\+I\+O\+N\+\_\+\+E\+N\+T\+ER void arm\+\_\+fir\+\_\+fast\+\_\+q31 (
\begin{DoxyParamCaption}
\item[{const arm\+\_\+fir\+\_\+instance\+\_\+q31 $\ast$}]{S, }
\item[{q31\+\_\+t $\ast$}]{p\+Src, }
\item[{q31\+\_\+t $\ast$}]{p\+Dst, }
\item[{uint32\+\_\+t}]{block\+Size}
\end{DoxyParamCaption}
)}\hypertarget{group__FIR_ga70d11af009dcd25594c58c75cdb5d6e3}{}\label{group__FIR_ga70d11af009dcd25594c58c75cdb5d6e3}
...
\end{DoxyParagraph}
\begin{DoxyParagraph}{}
Refer to the function {\ttfamily \hyperlink{group__FIR_gaadd938c68ab08967cbb5fc696f384bb5}{arm\+\_\+fir\+\_\+q31()}} for a slower implementation of this function which uses a 64-\/bit accumulator to provide higher precision. Both the slow and the fast versions use the same instance structure. Use the function {\ttfamily \hyperlink{group__FIR_gac00d53af87684cbbe135767b55e748a5}{arm\+\_\+fir\+\_\+init\+\_\+q31()}} to initialize the filter structure. 
\end{DoxyParagraph}
\index{Finite Impulse Response (\+F\+I\+R) Filters@{Finite Impulse Response (\+F\+I\+R) Filters}!arm\+\_\+fir\+\_\+init\+\_\+f32@{arm\+\_\+fir\+\_\+init\+\_\+f32}}
\index{arm\+\_\+fir\+\_\+init\+\_\+f32@{arm\+\_\+fir\+\_\+init\+\_\+f32}!Finite Impulse Response (\+F\+I\+R) Filters@{Finite Impulse Response (\+F\+I\+R) Filters}}
...
\begin{DoxyParamCaption}
\item[{arm\+\_\+fir\+\_\+instance\+\_\+f32 $\ast$}]{S, }
\item[{uint16\+\_\+t}]{num\+Taps, }
\item[{float32\+\_\+t $\ast$}]{p\+Coeffs, }
\item[{float32\+\_\+t $\ast$}]{p\+State, }
\item[{uint32\+\_\+t}]{block\+Size}
\end{DoxyParamCaption}
)}\hypertarget{group__FIR_ga98d13def6427e29522829f945d0967db}{}\label{group__FIR_ga98d13def6427e29522829f945d0967db}
...
\end{DoxyParagraph}
\index{Finite Impulse Response (\+F\+I\+R) Filters@{Finite Impulse Response (\+F\+I\+R) Filters}!arm\+\_\+fir\+\_\+init\+\_\+q15@{arm\+\_\+fir\+\_\+init\+\_\+q15}}
\index{arm\+\_\+fir\+\_\+init\+\_\+q15@{arm\+\_\+fir\+\_\+init\+\_\+q15}!Finite Impulse Response (\+F\+I\+R) Filters@{Finite Impulse Response (\+F\+I\+R) Filters}}
...
\begin{DoxyParamCaption}
\item[{arm\+\_\+fir\+\_\+instance\+\_\+q15 $\ast$}]{S, }
\item[{uint16\+\_\+t}]{num\+Taps, }
\item[{q15\+\_\+t $\ast$}]{p\+Coeffs, }
\item[{q15\+\_\+t $\ast$}]{p\+State, }
\item[{uint32\+\_\+t}]{block\+Size}
\end{DoxyParamCaption}
)}\hypertarget{group__FIR_gae2a50f692f41ba57e44ed0719b1368bd}{}\label{group__FIR_gae2a50f692f41ba57e44ed0719b1368bd}
...
\end{DoxyParagraph}
\begin{DoxyParagraph}{}
{\ttfamily p\+State} points to the array of state variables. {\ttfamily p\+State} is of length {\ttfamily num\+Taps+block\+Size}, when running on Cortex-\/\+M4 and Cortex-\/\+M3 and is of length {\ttfamily num\+Taps+block\+Size-\/1}, when running on Cortex-\/\+M0 where {\ttfamily block\+Size} is the number of input samples processed by each call to {\ttfamily \hyperlink{group__FIR_ga262d173058d6f80fdf60404ba262a8f5}{arm\+\_\+fir\+\_\+q15()}}. 
\end{DoxyParagraph}
\index{Finite Impulse Response (\+F\+I\+R) Filters@{Finite Impulse Response (\+F\+I\+R) Filters}!arm\+\_\+fir\+\_\+init\+\_\+q31@{arm\+\_\+fir\+\_\+init\+\_\+q31}}
\index{arm\+\_\+fir\+\_\+init\+\_\+q31@{arm\+\_\+fir\+\_\+init\+\_\+q31}!Finite Impulse Response (\+F\+I\+R) Filters@{Finite Impulse Response (\+F\+I\+R) Filters}}
...
\begin{DoxyParamCaption}
\item[{arm\+\_\+fir\+\_\+instance\+\_\+q31 $\ast$}]{S, }
\item[{uint16\+\_\+t}]{num\+Taps, }
\item[{q31\+\_\+t $\ast$}]{p\+Coeffs, }
\item[{q31\+\_\+t $\ast$}]{p\+State, }
\item[{uint32\+\_\+t}]{block\+Size}
\end{DoxyParamCaption}
)}\hypertarget{group__FIR_gac00d53af87684cbbe135767b55e748a5}{}\label{group__FIR_gac00d53af87684cbbe135767b55e748a5}
...
\end{DoxyParagraph}
\index{Finite Impulse Response (\+F\+I\+R) Filters@{Finite Impulse Response (\+F\+I\+R) Filters}!arm\+\_\+fir\+\_\+init\+\_\+q7@{arm\+\_\+fir\+\_\+init\+\_\+q7}}
\index{arm\+\_\+fir\+\_\+init\+\_\+q7@{arm\+\_\+fir\+\_\+init\+\_\+q7}!Finite Impulse Response (\+F\+I\+R) Filters@{Finite Impulse Response (\+F\+I\+R) Filters}}
...
\begin{DoxyParamCaption}
\item[{arm\+\_\+fir\+\_\+instance\+\_\+q7 $\ast$}]{S, }
\item[{uint16\+\_\+t}]{num\+Taps, }
\item[{q7\+\_\+t $\ast$}]{p\+Coeffs, }
\item[{q7\+\_\+t $\ast$}]{p\+State, }
\item[{uint32\+\_\+t}]{block\+Size}
\end{DoxyParamCaption}
)}\hypertarget{group__FIR_ga88e48688224d42dc173dbcec702f0c1d}{}\label{group__FIR_ga88e48688224d42dc173dbcec702f0c1d}

\begin{DoxyParams}[1]{Parameters}
\mbox{\tt in,out}  & {\em $\ast$S} & points to an instance of the Q7 F\+IR filter structure. \\
\hline
\mbox{\tt in}  & {\em num\+Taps} & Number of filter coefficients in the filter. \\
\hline
\mbox{\tt in}  & {\em $\ast$p\+Coeffs} & points to the filter coefficients buffer. \\
...
\end{DoxyParagraph}
\begin{DoxyParagraph}{}
{\ttfamily p\+State} points to the array of state variables. {\ttfamily p\+State} is of length {\ttfamily num\+Taps+block\+Size-\/1} samples, where {\ttfamily block\+Size} is the number of input samples processed by each call to {\ttfamily \hyperlink{group__FIR_ga31c91a0bf0962327ef8f626fae68ea32}{arm\+\_\+fir\+\_\+q7()}}. 
\end{DoxyParagraph}
\index{Finite Impulse Response (\+F\+I\+R) Filters@{Finite Impulse Response (\+F\+I\+R) Filters}!arm\+\_\+fir\+\_\+q15@{arm\+\_\+fir\+\_\+q15}}
\index{arm\+\_\+fir\+\_\+q15@{arm\+\_\+fir\+\_\+q15}!Finite Impulse Response (\+F\+I\+R) Filters@{Finite Impulse Response (\+F\+I\+R) Filters}}
...
\item[{uint32\+\_\+t}]{block\+Size}
\end{DoxyParamCaption}
)}\hypertarget{group__FIR_ga262d173058d6f80fdf60404ba262a8f5}{}\label{group__FIR_ga262d173058d6f80fdf60404ba262a8f5}
...
\end{DoxyParagraph}
\index{Finite Impulse Response (\+F\+I\+R) Filters@{Finite Impulse Response (\+F\+I\+R) Filters}!arm\+\_\+fir\+\_\+q31@{arm\+\_\+fir\+\_\+q31}}
\index{arm\+\_\+fir\+\_\+q31@{arm\+\_\+fir\+\_\+q31}!Finite Impulse Response (\+F\+I\+R) Filters@{Finite Impulse Response (\+F\+I\+R) Filters}}
...
\item[{uint32\+\_\+t}]{block\+Size}
\end{DoxyParamCaption}
)}\hypertarget{group__FIR_gaadd938c68ab08967cbb5fc696f384bb5}{}\label{group__FIR_gaadd938c68ab08967cbb5fc696f384bb5}
...
\end{DoxyParagraph}
\begin{DoxyParagraph}{}
Refer to the function {\ttfamily \hyperlink{group__FIR_ga70d11af009dcd25594c58c75cdb5d6e3}{arm\+\_\+fir\+\_\+fast\+\_\+q31()}} for a faster but less precise implementation of this filter for Cortex-\/\+M3 and Cortex-\/\+M4. 
\end{DoxyParagraph}
\index{Finite Impulse Response (\+F\+I\+R) Filters@{Finite Impulse Response (\+F\+I\+R) Filters}!arm\+\_\+fir\+\_\+q7@{arm\+\_\+fir\+\_\+q7}}
\index{arm\+\_\+fir\+\_\+q7@{arm\+\_\+fir\+\_\+q7}!Finite Impulse Response (\+F\+I\+R) Filters@{Finite Impulse Response (\+F\+I\+R) Filters}}
...
\begin{DoxyParamCaption}
\item[{const arm\+\_\+fir\+\_\+instance\+\_\+q7 $\ast$}]{S, }
\item[{q7\+\_\+t $\ast$}]{p\+Src, }
\item[{q7\+\_\+t $\ast$}]{p\+Dst, }
\item[{uint32\+\_\+t}]{block\+Size}
\end{DoxyParamCaption}
)}\hypertarget{group__FIR_ga31c91a0bf0962327ef8f626fae68ea32}{}\label{group__FIR_ga31c91a0bf0962327ef8f626fae68ea32}
